...
-- ========== USERS ==========
INSERT INTO users (username, display_name, email, password_hash, bio, avatar_url, active, created_at, updated_at) VALUES ('alice', 'Alice Harper', 'alice@example.com', '$2a$10$JifCml6RRQgz/rhtl5oEL.O00aZ/uC0krKE1NxpXsSIRUFxKR4BPG', 'Platform engineer and maintainer of open source tooling.', 'https://avatars.example.com/u/alice.png', TRUE, DATEADD('DAY', -180, CURRENT_TIMESTAMP), DATEADD('DAY', -2, CURRENT_TIMESTAMP));
INSERT INTO users (username, display_name, email, password_hash, bio, avatar_url, active, created_at, updated_at) VALUES ('bob', 'Bob Martinez', 'bob@example.com', '$2a$10$JifCml6RRQgz/rhtl5oEL.O00aZ/uC0krKE1NxpXsSIRUFxKR4BPG', 'Site reliability engineer focused on observability stacks.', 'https://avatars.example.com/u/bob.png', TRUE, DATEADD('DAY', -150, CURRENT_TIMESTAMP), DATEADD('DAY', -1, CURRENT_TIMESTAMP));
INSERT INTO users (username, display_name, email, password_hash, bio, avatar_url, active, created_at, updated_at) VALUES ('carol', 'Carol Singh', 'carol@example.com', '$2a$10$JifCml6RRQgz/rhtl5oEL.O00aZ/uC0krKE1NxpXsSIRUFxKR4BPG', 'Data scientist experimenting with ML deployments.', 'https://avatars.example.com/u/carol.png', TRUE, DATEADD('DAY', -90, CURRENT_TIMESTAMP), DATEADD('DAY', -3, CURRENT_TIMESTAMP));
INSERT INTO users (username, display_name, email, password_hash, bio, avatar_url, active, created_at, updated_at) VALUES ('dave', 'Dave Patel', 'dave@example.com', '$2a$10$JifCml6RRQgz/rhtl5oEL.O00aZ/uC0krKE1NxpXsSIRUFxKR4BPG', 'Edge computing enthusiast hacking on IoT projects.', 'https://avatars.example.com/u/dave.png', TRUE, DATEADD('DAY', -60, CURRENT_TIMESTAMP), DATEADD('DAY', -1, CURRENT_TIMESTAMP));
-- ========== USER ROLES ==========
