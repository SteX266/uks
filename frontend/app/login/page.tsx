...
export default function LoginPage() {
  ...
  const executeLogin = async (loginUsername: string, loginPassword: string) => {
    ...
    const isPasswordChangeRequired = response.isPasswordChangeRequired;
    ...
    const role = roles.some((roleName) => roleName.includes("ADMIN"))
      ? "ADMIN"
      : "USER";
  ...
  const handlePasswordChange = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setIsSubmitting(true);
      await executeLogin(username, newPassword);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/70 px-4">
          <div className="w-full max-w-lg rounded-3xl bg-white p-8 shadow-2xl">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Before accessing the admin dashboard you must update the
              autogenerated password provided during setup.
            </p>
            ...
            <form onSubmit={handlePasswordChange} className="mt-6 space-y-5">
              ...
              <div className="flex items-center justify-end gap-3">
                <button
                  ...
                  className="rounded-xl border border-slate-200 px-4 py-3 text-sm font-semibold uppercase tracking-wide text-slate-600 transition hover:border-slate-300 hover:bg-slate-100"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="rounded-xl bg-sky-600 px-4 py-3 text-sm font-semibold uppercase tracking-wide text-white shadow-lg shadow-sky-200 transition hover:bg-sky-500 disabled:cursor-not-allowed disabled:bg-slate-400"
                >
